  ...
  return (
    <div className="Main"> {/* Add this wrapper to center the container */}
      <div className="container">
        <div className="box box1" onClick={() => navigate('/digitalframework/page1')}>
          <FontAwesomeIcon icon={faServer} className="icon" />
          Information, data and media literacies
        </div>
        <div className="box box2" onClick={() => navigate('/digitalframework/page2')}>
          <FontAwesomeIcon icon={faSitemap} className="icon" />
          Digital creation, scholarship and innovation
        </div>
        <div className="box box3" onClick={() => navigate('/digitalframework/page3')}>
          <FontAwesomeIcon icon={faTty} className="icon" />
          Digital Communication, Collaboration and participation
        </div>
        <div className="box box4" onClick={() => navigate('/digitalframework/page4')}>
          <FontAwesomeIcon icon={faGraduationCap} className="icon" />
          Digital Learning and Development
        </div>
        <div className="box box5" onClick={() => navigate('/digitalframework/page5')}>
          <FontAwesomeIcon icon={faAddressCard} className="icon" />
          Digital identity and wellbeing
        </div>
        <div className="box box6" onClick={() => navigate('/digitalframework/page6')}>
